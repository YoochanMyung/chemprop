...
def run_Chemprop(args):
    ...
    train_feat_path = os.path.join(db_dir, 'full_features_only', '{}_train.csv'.format(label)) 
    val_feat_path =  os.path.join(db_dir, 'full_features_only', '{}_val.csv'.format(label)) 
    test_feat_path =  os.path.join(db_dir, 'full_features_only', '{}_test.csv'.format(label)) 
